...
import com.tianji.media.mapper.MediaFileMapper;
...
public class FileServiceImpl extends ServiceImpl<MediaFileMapper, File> implements IFileService {
    ...
    public FileDTO uploadFile(MultipartFile file) {
        ...
        // 6.返回
        return FileDTO.of(fileInfo.getId(), originalFilename, fileInfo.getPlatform().getPath() + filename);
    }

...
import com.tianji.media.storage.SimpleMediaStorageAdapter;
...
public class MediaServiceImpl extends ServiceImpl<MediaMapper, Media> implements IMediaService {
    ...
    private final SimpleMediaStorageAdapter mediaStorage;
    ...
    public VideoPlayVO getPlaySignatureBySectionId(Long sectionId) {
        ...
        if(lessonId != null){
            ...
            // 1）获取签名 - 修改为IFileStorage兼容的方式
            String signature =  mediaStorage.getPlaySignature(media.getFileId(), null, null);
            // 2）返回

...
public class ContentPublishCalendarJobHandler {
    public static final String HANDLER_NAME = "contentPublishCalendarWarmupJobHandler";

    private final ContentPublishCalendarService contentPublishCalendarService;

    @XxlJob(HANDLER_NAME)
    public void execute() {
        List<ContentPublishCalendarVO> warmed = contentPublishCalendarService.warmupAllTenants();
        ...
        log.info("content publish calendar warmup finished: {}", message);
